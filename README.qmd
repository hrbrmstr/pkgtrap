...
`pkgtrap` ([GL](https://gitlab.com/hrbrmstr/pkgtrap)|[NPM](https://www.npmjs.com/package/pkgtrap)|[Docs](https://hrbrmstr.gitlab.io/pkgtrap/pkgtrap/0.1.1/)) is a small Node.js CLI application to make it easier to sync WebR WASM R packages to a local filesystem for CLI or web apps.
